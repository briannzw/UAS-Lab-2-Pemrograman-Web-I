...
<html>
    ...
    <body>
        ...
        <form action="login.php" method="post" autocomplete="off" class="form-login">
            <div class="logo">
                ...
                <p>Password</p>
                <input type="password" name="pass" placeholder="Enter your password..." class="form-control" style="margin-bottom:5px;" required>
                <a href="register.php" style="text-decoration: none;">Register here</a>
                <br>
                <input type="submit" name="login" value="Login" class="btn btn-outline-success me-2" style="margin-top:5px;">
